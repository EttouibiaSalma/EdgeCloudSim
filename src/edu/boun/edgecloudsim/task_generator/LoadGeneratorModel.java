...
// The load generator module is responsible for generating tasks for the given configuration.
// By default, the tasks are generated according to a Poisson distribution via active/idle task generation pattern.
// In order to have other task generation pattern this class should be extended
