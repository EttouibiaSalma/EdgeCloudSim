...
//SimEntity: represents a simulation entity (such as Cloudlet, VM, Host etc) that is
// able to send messages to other entities and process received messages as well
//as fire and handle events. SimEntity class provides the ability to schedule new events
// and send messages to other entities, where network delay is calculated according
// to the BRITE model.
